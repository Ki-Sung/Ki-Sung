...
어떻게하면 데이터가 가지는 의미를 좀 더 쉽게, 좀 더 편하게 표현할 지 늘 고민합니다.

현재는 패스트캠퍼스 데이터사이언스 스쿨 17기를 하고 있으며, 
EDA, 회귀분석, 크롤링 등 main 프로젝트와 sub 프로젝트 등 다양한 프로젝트를 진행하고 있습니다.
</pre>
